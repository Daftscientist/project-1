...
Following this, you will (temporarily, till a custom wrapper is developed) follow the steps [here](https://linuxcontainers.org/incus/docs/main/authentication/#using-json-web-token-jwt-to-perform-tls-authentication) to generate a JWT token - which is asked for when adding a 'Node' to the panel.
