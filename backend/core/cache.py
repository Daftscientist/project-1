...
async def update(uuid: str, email: str = None, username: str = None, avatar: str = None, google_account_identifier: str = None, discord_account_identifier: str = None) -> dict:
    if email:
        del CACHED_EMAIL_TO_UUID[CACHED_DATA[uuid]["email"]]
