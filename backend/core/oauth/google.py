...
CLIENT_ID = load_config()["oauth"]["google"]["client_id"]
CLIENT_SECRET = load_config()["oauth"]["google"]["client_secret"]

API_BASE_URL = "https://accounts.google.com/o"
AUTHORIZATION_BASE_URL = API_BASE_URL + "/oauth2/auth"
TOKEN_URL = API_BASE_URL + "/oauth2/token"

class GoogleOAuth(object):
    """
    GoogleOAuth class for handling Google OAuth2 authentication.
    ...
    Args:
        ...
        client_id (str): The client ID of your Google application.
        client_secret (str): The client secret of your Google application.
    """

    def __init__(self, redirect_uri: str, scopes: list, client_id: str, client_secret: str):
        """
        Initializes a GoogleOAuth object.
    ...
    def get_login_url(self):
        ...
        This method generates the OAuth2 authorization URL for Google authentication.
        ...
        """
        login_url, state = self.oauth.authorization_url(AUTHORIZATION_BASE_URL, access_type="offline")
